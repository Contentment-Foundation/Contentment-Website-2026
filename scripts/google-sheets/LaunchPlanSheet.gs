...
function applyReviewFeedbackControls_(sheet) {
  ...
  sheet.getRange(tipRow, 1, 1, 6).merge()
    .setValue('How to use: one row per issue. Filter Status = Open. Preview: https://contentmentweb2.netlify.app/ — add RF-xxx IDs sequentially.')
    .setFontStyle('italic')
    .setFontColor('#555555')
    .setWrap(true);
