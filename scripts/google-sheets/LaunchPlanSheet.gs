...
const STATUS_OPTIONS = {
  tickets:          ['Open', 'In Progress', 'Blocked', 'Paused', 'Scheduled', 'Done'],
  decisions:        ['Open', 'Partial', 'Resolved'],
