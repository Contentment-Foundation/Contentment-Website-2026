...
> **Last updated:** 30 July 2026 · Somesh Bhardwaj  
...
| FEAT-002 | Multi-page routing scaffold (Astro) | FEAT | 1 | Must | 🟡 In Progress | Somesh | Engineering | Jun 2026 | — | FEAT-001 | Astro 4.x confirmed (D-23/HC-055). All 7 Phase 1 content routes exist under `src/pages/` (`/`, `/about`, `/why`, `/our-impact`, `/schools`, `/events`, `/give`). Utility pages (privacy/terms/404) not started. |
...
| FEAT-004 | Wire all nav and footer links | FEAT | 1 | Must | 🔵 Open | Somesh | Engineering | Jun 2026 | — | FEAT-002 | Internal page links wired via Astro routes. External donate/join/social still empty in `src/config/seams.ts` (HC-030/071, FEAT-005). |
| FEAT-010 | Migrate homepage to `/` route | FEAT | 1 | Must | 🟡 In Progress | Somesh | Dave Kebo | Jun 2026 | — | FEAT-001, FEAT-002 | Jul 29 — `src/pages/index.astro` + 10 section components. Responsive audit done 30 Jul (`HOMEPAGE-RESPONSIVE-AUDIT.md`); awaiting Slack review (HC-057). Seams still empty. |
| FEAT-011 | Homepage copy audit vs messaging brief | FEAT | 1 | Should | 🔵 Open | Somesh | Engineering | Jun 2026 | — | FEAT-010 | — |
| FEAT-020 | Build `/why` page | FEAT | 1 | Must | 🟡 In Progress | Somesh | Engineering | Jun 2026 | — | FEAT-001, FEAT-002 | Jul 29 — ported to `src/pages/why.astro` from Dave why-wellbeing handoff (verbatim). Needs responsive/QA pass + Slack review after homepage. |
