...
A status must answer **"is anyone on our side moving on this?"** Before 5 Aug, twelve tickets sat at `In Progress` whether the remaining work was ours or someone else's, so the Sheet could not tell "Sam is building this" from "this has sat on one person for a week."
